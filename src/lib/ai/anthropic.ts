  ...
  try {
    message = await anthropic.messages.create({
      ...
      system:
        ...
        "6) Görsel olmadan OKUNAMAYAN/anlaşılamayan soru üretme (ör. bir fotoğraftaki nesneleri sayma, bir haritada renkli bölgeyi okuma) - ama pasta/çubuk grafiğin dilimleri, bir tablonun hücreleri, bir oda/koridor düzeninin numaralandırması gibi veriler TAMAMEN METİNLE (gerekirse madde/tablo halinde) eksiksiz betimlenebiliyorsa bu tür 'veriyi metinle temsil eden' sorular YAZILABİLİR ve TYT/AYT/YKS Matematik-Geometri gibi derslerde teşvik edilir - ÖSYM'nin gerçek sınavlarında da grafik/şekil çoğu zaman böyle sözel biçimde soru köküne gömülüdür. Her soru için 4 şık (A-D) ve tek doğru cevap olmalı.\n" +
        (isNumericSubject
          ? "7) Bu ders SAYISAL (Matematik/Geometri/Fizik/Kimya/Fen Bilimleri gibi) - ÖSYM'nin gerçek sınavlarındaki gibi soruyu SOYUT bir işlem/formül sorusu olarak sorma ('2x+5=17 ise x kaçtır?' gibi kuru sorulardan KAÇIN), bunun yerine bir GÜNLÜK HAYAT/GERÇEK DÜNYA SENARYOSU içinde sun (bir çiftçi, fabrika, market, yolculuk, yüzde/oran, para problemi, aidat/kira, işçi-havuz, yaş problemi, olasılık, kombinasyon gibi somut bir bağlam kur, sonra sayısal veriyi bu bağlam içinde ver). 'Kolay' zorlukta bile (tek/iki adımlı olsa da) bağlam cümlesiyle başlamalı. ÖNEMLİ - TYT/AYT/YKS sınav türü ve 'orta'/'zor'/'çok zor' zorluk kademesi için: gerçek ÖSYM sorularının çoğu TEK ADIMLI değildir - soru kökü genelde 3-6 cümle uzunluğunda, BİRDEN FAZLA veri/koşul içerir (ör. iki farklı olay/kişi/nesne karşılaştırılır, bir oran zincirinden geçilir, önce bir ara değer bulunup sonra asıl soru cevaplanır) ve öğrenciden bu verileri birbirine bağlayarak EN AZ İKİ İŞLEM ADIMINDA sonuca ulaşması istenir - kısa, tek cümlelik, tek işlemli bir soru kökü TYT/AYT/YKS 'orta' ve üzeri zorlukta YETERSİZ sayılır, üretme. 'Kolay' zorlukta tek adımlı olabilir ama yine de gerçekçi bir bağlam cümlesiyle kurulmalı.\n"
          : "") +
